package com.vip.base.common.view;

import com.vip.base.file.cache.CacheCallback;
...
public class CustomWebView extends WebView {
	...
	private void compatAddURLCacheCallback(String url, CacheCallback callback) {
		if (android.os.Build.VERSION.SDK_INT >=
			...
			com.vip.base.file.cache.WebViewCacheClient wvcc = 
					(com.vip.base.file.cache.WebViewCacheClient) mWebViewClient;
	...
	public void setWebViewClient(WebViewClient client) {
		if (android.os.Build.VERSION.SDK_INT >=
			...
			super.setWebViewClient(mWebViewClient = new 
					com.vip.base.file.cache.WebViewCacheClient(client));
		} else {
